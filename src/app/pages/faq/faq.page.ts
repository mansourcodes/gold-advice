...
export class FaqPage implements OnInit {
  ...
  faqlist = [
    ...
    },
    {
      ...
      body: ' طبعا تحديد السعر بأنه غالي هي مسألة نسبية، قد نرى ان المبلغ غالي لكن عند آخرين قد يكون مقبول، والعكس صحيح. لذلك كل ما يطرح من خلال التطبيق هو مجرد رأي.',
    },
    {
